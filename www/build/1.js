...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__list_a__ = __webpack_require__(281);
...
var ListAPageModule = /** @class */ (function () {
    ...
    ListAPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__list_a__["a" /* ListAPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__list_a__["a" /* ListAPage */]), __WEBPACK_IMPORTED_MODULE_3__directives_directives_module__["a" /* DirectivesModule */]
            ],
        })
    ], ListAPageModule);
...
//# sourceMappingURL=list-a.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_lazy_load__ = __webpack_require__(277);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ListAPage = /** @class */ (function () {
    function ListAPage(navCtrl, navParams, httpClint) {
    ...
    ListAPage.prototype.loadList = function (e) {
        var _this = this;
    ...
    ListAPage.prototype.refresh = function (e) {
        this.items = [];
        this.loadList(e);
    };
    ListAPage.prototype.loadMore = function (e) {
        this.loadList(e);
    };
    ListAPage.prototype.scrollEnd = function (content) {
        __WEBPACK_IMPORTED_MODULE_3__app_lazy_load__["a" /* LazyLoad */].getInstance().scrollEnd(content);
    };
    ListAPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list-a',template:/*ion-inline-start:"E:\work_new\ionic-image-lazyloader\src\pages\list-a\list-a.html"*/'<!--\n  Generated template for the ListAPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>list-a</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="outer-content" #content (ionScrollEnd)="scrollEnd(content)">\n\n  <ion-refresher (ionRefresh)="refresh($event)">\n    <ion-refresher-content></ion-refresher-content>\n  </ion-refresher>\n\n  <ion-list>\n    <ion-item *ngFor="let item of items">\n      <ion-thumbnail item-start><img [lazy-src]="item.picture.thumbnail" [lazy-content]="content"></ion-thumbnail>\n      <h3>{{item.name.first}} {{item.name.last}}</h3>\n      <p>{{item.dob}}</p>\n      <ion-note item-end>{{item.phone}}</ion-note>\n    </ion-item>\n  </ion-list>\n\n  <ion-infinite-scroll (ionInfinite)="loadMore($event)">\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n'/*ion-inline-end:"E:\work_new\ionic-image-lazyloader\src\pages\list-a\list-a.html"*/,
        }),
